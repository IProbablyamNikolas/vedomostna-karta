...
questions_list.append(Question('Kedy sa SR kvalifikovalo na MS?', '2010', '2012', '2022', '1322'))
...
def check_answer():
    ...
    if answers[0].isChecked():
        print("Štatistika")
        print("- Počet otázok:", window.total)
        print("- správne odpovede:", window.score)
...
def next_question():
    ...
    # táto funkcia potrebuje premennú, ktorá udáva číslo aktuálnej otázky
    # táto premenná môže byť globálna alebo môže byť vlastnosťou „globálneho objektu“ (aplikácie alebo okna)
    # vytvoríme vlastnosť window.cur_question (nižšie)
    window.total += 1
